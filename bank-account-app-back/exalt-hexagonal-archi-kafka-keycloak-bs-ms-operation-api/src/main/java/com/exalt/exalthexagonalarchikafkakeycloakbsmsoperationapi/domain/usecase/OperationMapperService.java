...
public class OperationMapperService {
    private OperationMapperService(){}
    ...
    public static Operation mapFromOperationRequestDto(OperationRequestDto operationRequestDto) {
        ...
        operation.setTransactionAmount(operationRequestDto.transactionAmount());
    ...
    public static Object mapFromAccountResponseDto(AccountResponseDto accountResponseDto) {
        ...
        if(accountResponseDto.accountType().equals("CURRENT")){
            bankAccount.setOverdraft(bankAccount.getOverdraft());
        }

        else if (accountResponseDto.accountType().equals("SAVING")) {
            bankAccount.setInterestRate(bankAccount.getInterestRate());
        }
