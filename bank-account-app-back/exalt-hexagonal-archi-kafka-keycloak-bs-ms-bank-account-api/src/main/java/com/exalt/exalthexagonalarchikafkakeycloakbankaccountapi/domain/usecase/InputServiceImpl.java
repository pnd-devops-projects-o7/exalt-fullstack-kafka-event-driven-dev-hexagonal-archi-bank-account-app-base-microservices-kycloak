...
public class InputServiceImpl implements InputService {
    ...
    public InputServiceImpl(OutputService outputService, RemoteClientService remoteClientService, KafkaEventProducer kafkaEventProducer) {
    ...
    public AccountResponseDto createAccount(AccountRequestDto accountRequestDto) {
        ...
        bankAccount.setCustomer(MapperService.mapToCustomer(customerResponseDto));
        ...
        if (bankAccountEntity instanceof CurrentAccount currentAccount) {
            ...
            kafkaEventProducer.createAccountEvent(bankAccountEvent);
    ...
    public AccountResponseDto activateAccount(String accountId) {
        ...
        kafkaEventProducer.activateAccountEvent(bankAccountEvent);
        return MapperService.mapToAccountResponseDto(bankAccountEntity, customerResponseDto);
    }
    ...
    public AccountResponseDto suspendAccount(String accountId) {
        ...
        //call kafka connector to send kafka event into kafka infra
        kafkaEventProducer.suspendAccountEvent(bankAccountEvent);
        return MapperService.mapToAccountResponseDto(bankAccountEntity, customerResponseDto);
    }
}
