...
public class SavingAccountEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8552189704931347747L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SavingAccountEvent\",\"namespace\":\"com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans\",\"fields\":[{\"name\":\"accountId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"accountState\",\"type\":{\"type\":\"enum\",\"name\":\"AccountState\",\"symbols\":[\"CREATED\",\"ACTIVE\",\"SUSPENDED\"]}},{\"name\":\"balance\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":7,\"scale\":3}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"interestRate\",\"type\":\"double\"},{\"name\":\"customer\",\"type\":{\"type\":\"record\",\"name\":\"Customer\",\"namespace\":\"com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.customer\",\"fields\":[{\"name\":\"customerId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"firstname\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastname\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"email\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"customerState\",\"type\":{\"type\":\"enum\",\"name\":\"CustomerState\",\"symbols\":[\"ACTIVE\",\"ARCHIVE\"]}},{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}}]}");
  ...
  private static final BinaryMessageEncoder<SavingAccountEvent> ENCODER =
      new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SavingAccountEvent> DECODER =
   ...
   */
  public static BinaryMessageEncoder<SavingAccountEvent> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SavingAccountEvent> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SavingAccountEvent> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SavingAccountEvent to a ByteBuffer.
  ...
  /**
   * Deserializes a SavingAccountEvent from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SavingAccountEvent instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SavingAccountEvent fromByteBuffer(
   ...
   */
  public SavingAccountEvent(java.util.UUID accountId, com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.AccountState accountState, java.nio.ByteBuffer balance, java.time.Instant createdAt, java.lang.Double interestRate, com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.customer.Customer customer) {
  ...
  /**
   * Creates a new SavingAccountEvent RecordBuilder.
   * @return A new SavingAccountEvent RecordBuilder
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder newBuilder() {
    return new com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder();
  }

  /**
   * Creates a new SavingAccountEvent RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SavingAccountEvent RecordBuilder
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder newBuilder(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder other) {
    if (other == null) {
      return new com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder();
    } else {
      return new com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder(other);
    }
  }

  /**
   * Creates a new SavingAccountEvent RecordBuilder by copying an existing SavingAccountEvent instance.
   * @param other The existing instance to copy.
   * @return A new SavingAccountEvent RecordBuilder
   */
  public static com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder newBuilder(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent other) {
    if (other == null) {
      return new com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder();
    } else {
      return new com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder(other);
  ...
  /**
   * RecordBuilder for SavingAccountEvent instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SavingAccountEvent>
    implements org.apache.avro.data.RecordBuilder<SavingAccountEvent> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SavingAccountEvent instance
     * @param other The existing instance to copy.
     */
    private Builder(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.accountId)) {
        this.accountId = data().deepCopy(fields()[0].schema(), other.accountId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setAccountId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearAccountId() {
      accountId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setAccountState(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.AccountState value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearAccountState() {
      accountState = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setBalance(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearBalance() {
      balance = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setInterestRate(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearInterestRate() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setCustomer(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.customer.Customer value) {
    ...
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder setCustomerBuilder(com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.customer.Customer.Builder value) {
      clearCustomer();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.exalt.exalthexagonalarchikafkakeycloakbankaccountapi.domain.avro_beans.SavingAccountEvent.Builder clearCustomer() {
      customer = null;
    ...
    public SavingAccountEvent build() {
      try {
        SavingAccountEvent record = new SavingAccountEvent();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SavingAccountEvent>
    WRITER$ = (org.apache.avro.io.DatumWriter<SavingAccountEvent>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SavingAccountEvent>
    READER$ = (org.apache.avro.io.DatumReader<SavingAccountEvent>)MODEL$.createDatumReader(SCHEMA$);
